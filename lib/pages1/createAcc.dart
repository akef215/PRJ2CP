          ...
          children: [
            ...
            Align(// Makes sure Container is in the center of stack
              ...
              child: SingleChildScrollView( // Ensures UI not shrinking when keyboard shows
                physics: BouncingScrollPhysics(), // Prevents user scrolling

                child: Container(  /*-------------MAIN BOX-------------*/
                  constraints: BoxConstraints(
                    minHeight: screenHeight * 0.92, // Prevents shrinking
                    maxWidth: screenWidth * 0.85,
                  ),
                  padding: EdgeInsets.symmetric(horizontal: 50.0, vertical: 70.0),
                  margin: EdgeInsets.fromLTRB(35.0, 40.0, 35.0, 10.0),
            ...
            Align(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: 65), // Push text down
                  Padding(
                    ...
                    children: [
                      ...
                      Container(/*---------ESI IDENTIFIER BOX----------*/
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            controller: esiIdController,
                            style: TextStyle(color: Colors.black), // User input text black
                            decoration: InputDecoration(
                              hintText: "Enter Esi ID" ,
                              hintStyle: TextStyle(
                                color: Colors.grey[500] ,
                                fontSize: 15 ,
                              ),
                              border: InputBorder.none, // Removes the default black line of TextField
                              suffixIcon: Icon(Icons.badge , color: Colors.grey[400],),
                              contentPadding: EdgeInsets.symmetric(horizontal: 8.0, vertical: 8.0) ,
                            ),
                          ),
                        ),
