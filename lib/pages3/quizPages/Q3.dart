                ...
                GridView.builder(
                  ...
                  itemBuilder: (context, index){
                    ...
                    if (index == 0) {
                      ...
                      checkDx = 25; checkDy = 35;
                    } else if (index == 1) {
                      dx = 18; dy = -25;  // Move top-right
                      checkDx = -105 ; checkDy = 35;
                    } else if (index == 2) {
                      dx = -18; dy = -5;  // Move bottom-left
                      checkDx = 25; checkDy = -86;
                    } else if (index == 3) {
                      dx = 18; dy = -5;   // Move bottom-right
                      checkDx = -105; checkDy = -86;
                    }
                              ...
                              child: Stack(
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: SizedBox(
                                      width: 50, // Increase tap area
                                      height: 50,
                                      child: Transform.scale(
                                        scale: 1.5,
                                        child: Checkbox(
                                          value: selectedAnswer == index, // Replace with your logic
                                          activeColor: Color(0xff21334E), // Fill color when clicked
                                          checkColor: Colors.white, // Tick color
                                          side: BorderSide(color: Color(0xff21334E), width: 2),
                                          shape: RoundedRectangleBorder(
                                            borderRadius: BorderRadius.circular(8), // Adjust to make it rounded
                                          ),
