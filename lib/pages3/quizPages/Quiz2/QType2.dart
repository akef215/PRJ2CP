...
class QuizT2 extends StatefulWidget {
  const QuizT2({super.key});

  @override
  State<QuizT2> createState() => _QuizT2State();
}

class _QuizT2State extends State<QuizT2> {
  @override
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => Quiz2Page()));
            },
